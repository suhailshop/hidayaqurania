    ...
    e.validate(
        ...
        {select_multi:
            ...
            ,rules:{
                ...
                president:{minlength:2,required:!0},
                city:{minlength:2,required:!0},
                location:{minlength:2,required:!0},
                phonne:{minlength:2,required:!0},
                fax:{minlength:2,required:!0},
                contratid:{minlength:2,required:!0},
                contratdate:{minlength:2,required:!0},
                


                input_group:
                {
                    name:{minlength:2,name:!0},
                    president:{minlength:2,president:!0},
                    countrie:{required:0},
                    city:{minlength:2,city:!0},
                    location:{minlength:2,location:!0},
                    phonne:{minlength:2,phonne:!0},
                    fax:{minlength:2,fax:!0},
                    contratid:{minlength:2,contratid:!0},
                    contratdate:{minlength:2,contratdate:!0},
                    email:!0,required:!0},email:{required:!0,email:!0},
                ...
                invalidHandler:function(e,t){i.hide(),r.show(),App.scrollTo(r,-200)},errorPlacement:function(e,r){var i=$(r).parent(".input-group");i?i.after(e):r.after(e)},highlight:function(e){$(e).closest(".form-group").addClass("has-error")},unhighlight:function(e){$(e).closest(".form-group").removeClass("has-error")},success:function(e){e.closest(".form-group").removeClass("has-error")},submitHandler:function(e){i.show(),r.hide()}})},r=function(){var e=$("#form_sample_2"),r=$(".alert-danger",e),i=$(".alert-success",e);
                e.validate(
                    {errorElement:"span",errorClass:"help-block help-block-error",focusInvalid:!1,ignore:"",
                    rules:{
                        name:{minlength:2,required:!0},
                        president:{minlength:2,required:!0},
                        countrie:{minlength:1,required:!0},
                        city:{minlength:2,required:!0},
                        location:{minlength:2,required:!0},
                        phonne:{minlength:2,required:!0},
                        fax:{minlength:2,required:!0},
