 ...
 * ========================================================= */
 ...
 (function($) {
	...
	var dates = $.fn.calendar.dates = {
		en: {
			days: ["الأحد", "الاثنين", "الثلاثاء", "الاربعاء", "الخميس", "الجمعة", "السبت", "الأحد"],
			daysShort: ["أحد", "أثن", "ثلاث", "أرب", "خمي", "جمع", "سبت", "أحد"],
			daysMin: ["أح", "اث", "ثلا", "أر", "خم", "جم", "سب", "أح"],
			months: ["يناير", "فبراير", "مارس", "أبريل", "ماي", "يونيو", "يوليوز", "غشت", "شتنبر", "أكتوبر", "نونبر", "دجنبر"],
			monthsShort: ["ينا", "فبر", "مار", "ابر", "ماي", "يون", "يول", "غشت", "شتن", "اكت", "نون", "دجن"],
			weekStart:1
		}
	};
