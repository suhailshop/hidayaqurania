...
<form action="{{route('addSupervisorReportPost')}}" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
        {{ csrf_field() }}
            <div class="col-md-6">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="date" class="form-control" name="DateSupervisor" placeholder="التاريخ *"/> </div>
                                            </div>
                                    </div>
                                    <div class="form-group">
                                            <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="number" class="form-control" name="QualityProcess" placeholder="جودة البحث *"/> </div>
                                            </div>
                                    </div>
                                    <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="number" class="form-control" name="QualityDirection" placeholder="مدى الالتزام بالتوجيهات  *"/> </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="number" class="form-control" name="UpdatedRange" placeholder="القدر المعدل *"/> </div>
                                                </div>
                                        </div>
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <textarea class="form-control" name="NotesPositive" placeholder="الملاحظات الايجابية *"></textarea> </div>
                                                </div>
                                        </div>
                                        <div class="form-group">
                                                <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <textarea class="form-control" name="NotesNegative" placeholder="الملاحظات السلبية *"></textarea> </div>
                                                </div>
                                        </div>
