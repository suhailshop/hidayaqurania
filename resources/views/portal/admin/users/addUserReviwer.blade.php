    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="m-heading-1 border-yellow m-bordered">
                ...
                <p> المرجو ملء الخانات بالمعلومات الخاصة بالباحث المساعد :
            </div>
<div class="row">
    
<form action="{{route('addUserReviewerPost')}}" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
        {{ csrf_field() }}
            <div class="col-md-6">
                    ...
                    <div class="portlet light portlet-fit portlet-form ">
                        ...
                        <div class="form-body">
                            ...
                            <p class="hint">  الدولة : </p>
                            <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }} ">
                                <div class="col-md-12">
                                    <select class="form-control placeholder-no-fix" name="country"  >
