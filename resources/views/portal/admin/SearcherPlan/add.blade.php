...
<form action="{{route('addPlanAdminPost')}}" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
        {{ csrf_field() }}
    @csrf
            <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-form ">
                        ...
                        <input type="hidden" name="theID" value="{{$searcherID}}">
                                    ...
                                    <div class="form-group  margin-top-20">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" class="form-control" name="Record"  placeholder="عنوان المبحث *"/> </div>
                                        </div>
                                    </div>
