    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                                <i class="icon-graduation"></i>
                                 <a href="{{route('allSupervisor')}}">إدارة  المشرفين</a>
                                <i class="fa fa-angle-left"></i>
                            </li>
                        <li>
                            <span>مشرف جديد</span>
            ...
            <div class="m-heading-1 border-green m-bordered">
                <h3>أضافة مشرف جديد</h3>
                <p> المرجو ملء الخانات بالمعلومات الخاصة بالمشرف :
            </div>
<div class="row">
    
<form action="{{route('addSupervisorPost')}}" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
        {{ csrf_field() }}
            <div class="col-md-6">
                            ...
                            <!-- BEGIN FORM-->
                                <div class="form-body">
                                        ...
                                        <div class="alert alert-danger" role="alert">
                                                <strong>ملاحظة! </strong>         المرجو الاحتفاظ بمعلومات الحساب ليتم ارسالها للمشرف الجديد    
                                              </div>
