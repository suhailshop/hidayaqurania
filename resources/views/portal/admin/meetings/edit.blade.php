        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>تعديل لقاء</span>
                        </li>
                    </ul>
                </div>
            <!-- END PAGE HEADER-->
            <div class="m-heading-1 border-green m-bordered">
                <h3>تعديل معلومات اللقاء </h3>
                <p> المرجو ملء الخانات بالمعلومات الخاصة باللقاء :
            </div>
<div class="row">
    
<form action="{{route('editMeetingPost')}}" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
        {{ csrf_field() }}
            <div class="col-md-12">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group  margin-top-20">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                            <input type="text" class="form-control" name="name" value="{{$meeting->Name}}" placeholder="اسم اللقاء *"/> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="date" class="form-control" name="date" value="{{$meeting->Date}}" placeholder="التاريخ  *"/> </div>
                                        </div>
                                    </div>
                                    <div class="form-group  margin-top-20">
                                         ...
                                         <div class="col-md-12">
                                             ...
                                             <div class="input-icon right">
                                                 <i class="fa"></i>
                                             <input type="text" class="form-control" name="location" value="{{$meeting->Location}}" placeholder="المكان  *"/> </div>
                                         </div>
                                     </div>
