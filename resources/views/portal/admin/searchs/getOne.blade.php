                                 ...
                                 <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_1_3">
                                       <form role="form" method="POST" action="{{route('addadmin2_reports')}}" enctype="multipart/form-data">
                                          ...
                                          <hr>
                                          <ul>
                                             <li>1. تسجيل إضافة حقيقية والوصول إلى نتائج علمية متميزة في مجال الهدايات</li>
                                             <li>2. جودة الصناعة البحثية من حيث الأهداف، والتسلسل، والصياغة، والأسلوب، والتوثيق .. وغيرها.</li>
                                             <li>3. جودة الإخراج وحسن التنسيق.</li>
                                             <li>4. نسبة الهدايات التي استنبطها الباحث من عموم الهدايات التي أوردها.</li>
                                             <li>5. كثرة المصادر والمراجع.</li>
                                             <li>6. استيعاب طرق العلماء في استخراج الهدايات.</li>
                                             <li>7. شمول الهدايات بجميع مجالاتها.</li>
                                             <li>8. التزام الطرقة المثلى في صياغة الهداية.</li>
                                             <li>9. بروز شخصية الباحث.</li>
                                             <li>10. تنزيل الهدايات على الواقع.</li>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <select required class="form-control" name="q6" onchange="showReason(this);">
                                                ...
                                                <option value="متميز جداً">متميز جداً</option>
                                    ...
                                    <div class="tab-pane" id="tab_1_5">
                                       <form role="form" method="POST" action="{{route('addsearcher_reports')}}" enctype="multipart/form-data">
                                          ...
                                          <input type="hidden" value="{{$search->ID}}" name="search" />
                                          <div class="form-group">
                                             <label class="control-label ">1- إجمالي عدد الهدايات القرآنية التي تضمنتها رسالتك حتى تاريخه : </label>
                                          ...
                                          <div class="form-group">
                                             <label class="control-label ">3- أسباب عدم التواصل إن وجد : </label>
                                             <textarea required class="form-control " name="q3" ></textarea>
                                          </div>
                                          <div class="form-group">
                                             <label class="control-label ">4- عدد الجلسات الإشرافية : </label>
                                          ...
                                          <div class="form-group">
                                             <label class="control-label ">8- ما الصعوبات التي تواجه الباحث ( إن وجدت )  : </label>
                                             <textarea required class="form-control " name="q8" ></textarea>
                                          </div>
                                          <div class="form-group">
                                                                  ...
                                                                  <div class="modal-content">
                                                                     ...
                                                                     <div class="modal-body">
                                                                        <form role="form" method="POST"  action="#" enctype="multipart/form-data" id="print-me5">
                                                                           ...
                                                                           <div class="form-group">
                                                                              <label class="control-label ">1- إجمالي عدد الهدايات القرآنية (الجزئية) التي تضمنتها رسالتك حتى تاريخه : </label>
                                                                           ...
                                                                           <div class="form-group">
                                                                              <label class="control-label ">3- أسباب عدم التواصل إن وجدت : </label>
                                                                  ...
                                                                  <div class="modal-content">
                                                                     ...
                                                                     <div class="modal-body">
                                                                        <form role="form" method="POST" action="#"  id="print-me2" >
                                                                           ...
                                                                           <div class="form-group">
                                                                              <label class="control-label "> الملف : </label>
                                                                              <a class="btn btn-primary" target="_blank" href="{{ url('project/storage/app/public/admin2_reports/'.$search->admin2_reports[0]->filename) }}"> تقرير الإدارة </a>
                                                                           </div>
                                                                        </form>
                                                                     </div>
                                                                  </div>
