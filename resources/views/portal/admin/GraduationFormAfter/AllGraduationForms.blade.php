            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <span>اعتماد نماذج تسليم الرسالة بعد المناقشة</span>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">لائحة نماذج تسليم الرسالة النهائية بعد المناقشة والمرسلة من قبل الطلاب</span>
                        </div>
                        <div class="tools"> </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="all">ملف الرسالة النهائية للرسالة بصيغة PDF</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('postGraduationForm',['id'=>$searcher->UserId])}}" >
