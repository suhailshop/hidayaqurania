        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>تعديل معيار</span>
                        </li>
                    </ul>
                </div>
            <!-- END PAGE HEADER-->
            <div class="m-heading-1 border-green m-bordered">
                <h3>تعديل معلومات المعيار </h3>
                <p> المرجو ملء الخانات بالمعلومات الخاصة بالمعيار :
            </div>
<div class="row">
    
<form action="{{route('editCriteriaPost')}}" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
        {{ csrf_field() }}
            <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-icon right">
                                                ...
                                                <select  class="form-control" name="status" placeholder="الحالة *"/>
                                                    ...
                                                    <option @if($criteria->Status=='yes') selected @endif value="yes" >مفعلة</option>

                                                    <option @if($criteria->Status=='no') selected @endif value="no" >غير مفعلة</option>
                                                </select> </div>
                                        </div>
                                    </div>
