                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">لائحة المعايير بالنظام</span>
                        </div>
                        <div class="tools"> </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                <a href="{{route('editCriteria',['id'=>$criteria->ID])}}">
                                                ...
                                                data-title="هل تريد الحذف ؟" href="{{route('deleteCriteriaPost',['id'=>$criteria->ID])}}">
