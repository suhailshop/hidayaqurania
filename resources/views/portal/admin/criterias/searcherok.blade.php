...
@section('pageTitle', 'الباحثون المستوفون')
@section('pageStyle')
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">لائحة الباحثين المستوفين للمعايير بالنظام</span>
                        </div>
                        <div class="tools"> </div>
                    </div>
