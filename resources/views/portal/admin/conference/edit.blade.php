                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">تعديل المؤتمر </span>
                            </div>
                            <div class="tools"> </div>
                        </div>
                        ...
                        @endif
                         ...
                         <div class="portlet-body">
                                     ...
                                     {{Form::open(['route' => array('updateConference', $news->id)  ,'files'=>true,'class'=>'form-body'])}}



                                            <div class="form-group">
                                            <label for="exampleInputEmail1">عنوان المؤتمر</label>
                                            <input type="text" name='title' value="{{$news->title}}" class="form-control" placeholder="من فضلك أدخل عنوان المؤتمر"  required />
                                            </div>



                                            <div class="form-group">
                                            <label for="exampleInputEmail1">تعديل صورة المؤتمر</label>
