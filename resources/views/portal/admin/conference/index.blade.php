					...
					<div class="portlet light ">
						<div class="portlet-title">
							<div class="caption font-dark">
								...
								<span class="caption-subject bold uppercase">قائمة المؤتمرات المنشورة على الموقع الالكتروني</span>
							</div>
							<div class="tools"> </div>
						</div>
						<a href="{{route('addConference')}}" class="btn btn-success">إضافة مؤتمر جديد</a>
						<br><br>
       ...
       <table class='table table-striped table-bordered bootstrap-datatable datatable' dir="rtl">
        	...
        	@forelse($news as $new)
        		<tr>
        			...
        			<td><a class="btn btn-warning" href="{{route('editConference', [$new->id])}}"  >تعديل</a></td>
        			<td>

						{!! Form::open(['route' => array('deleteConference', $new->id)]) !!}
