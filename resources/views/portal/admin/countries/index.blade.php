                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">لائحة الدول بالنظام</span>
                        </div>
                        <div class="tools"> </div>
                    </div>
                    
                      <div>
                            <a class=" btn-group  btn-group-devided" href="{{route('addCountrie')}}">
                                <label class="btn btn-transparent yellow">
                                    <i class="icon-plus"></i> إضافة دولة جديدة   </label>
                            </a>
                        </div>
                        <br>
                                    ...
                                    <td>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                <a href="{{route('editCountrie',['id'=>$countrie->ID])}}">
                                                ...
                                                data-title="هل تريد الحذف ؟" href="{{route('deleteCountriePost',['id'=>$countrie->ID])}}">
