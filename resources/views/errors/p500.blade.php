...
<html lang="en" dir="rtl">
    <head>
        ...
        <link href="{!! asset('reourcesassets/global/plugins/font-awesome/css/font-awesome.min.css') !!}" rel="stylesheet" type="text/css" />
    ...
    <body class="  page-500-full-page">
            <div class="row">
                    <div class="col-md-12 page-500">
                        ...
                        <div class=" details">
                            <h3>المعذرة ! حدث خطأ ما .</h3>
                            <p> سنقوم باصلاح المشكل ! يمكنكم اعادة المحاول لاحقا
                                <br> </p>
                            <p>
                                <a href="{{route('portalwelcome')}}" class="btn red btn-outline"> عودة للرئيسية </a>
                                <br> </p>
                        </div>
                    </div>
                </div>
